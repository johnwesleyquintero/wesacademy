...
import { ArrowRight, Play, Users, Award, BookOpen, Star, TrendingUp, Zap, Target, Clock } from 'lucide-react';
            ...
            <div className="space-y-8 animate-fade-in">
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-600 leading-relaxed max-w-2xl">
                  From Python and AI to Digital Marketing and Leadership - learn the most in-demand skills 
                  from industry experts and transform your career in 2025.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Join thousands learning the most in-demand skills. These courses are flying off the virtual shelves!
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover courses in the most sought-after fields. From technology to personal development, 
              we've got the skills employers are looking for.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {categories.map((category) => (
              <div key={category.name} className="group bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 text-center">
                <div className={`w-16 h-16 ${category.color} rounded-xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {learningPaths.map((path) => (
              <div key={path.id} className="bg-gradient-to-br from-primary-50 to-secondary-50 rounded-xl p-8 border border-primary-100">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-500">{path.courses.length} courses included</span>
                  <Link
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Hand-picked courses from industry experts, covering the skills that matter most in today's job market.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <p className="text-xl text-primary-100">
              Join thousands of professionals who have advanced their careers with WesAcademy. 
              Start with our most popular courses or explore our complete catalog.
            </p>
