                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {achievements.map((achievement, index) => (
                      <div key={index} className={`p-4 rounded-lg border-2 ${
                        ...
                        <div className={`w-10 h-10 ${achievement.color} rounded-lg flex items-center justify-center mb-3`}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {achievements.map((achievement, index) => (
                    <div key={index} className={`p-6 rounded-lg border-2 ${
                      ...
                      <h4 className="text-lg font-semibold text-gray-900 mb-2">{achievement.name}</h4>
            ...
            {activeTab === 'certificates' && (
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-12 text-center">
                  ...
                  <h4 className="text-lg font-medium text-gray-900 mb-2">Complete your first course to earn a certificate</h4>
                  <p className="text-gray-600 mb-6">
                    Certificates are awarded when you complete all lessons and pass the final assessment.
                  </p>
                  <Link
                    to="/courses"
